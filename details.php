...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <style>
.slides {
  transform: translateX(-250px); /* Pindahkan lebih ke kiri */
  position: relative;
}
.content1 {
  height: auto;
...
<div class="co-md-6">
  <div class="bx">
   ...
   <?php addCart(); ?>
    ...
    <p class="title">Stok Produk: </i><?php echo $p_stock; ?></p>
    <div class="form-group">
    <label class="col-md-5 control-label">Jumlah Produk</label>
    <div class="col-md-7">
        <input type="number" name="product_qty" class="form-control" min="1" max="<?php echo $p_stock; ?>" required>
    </div>
</div>

    <p class="price">RP </i><span><?php echo $p_price; ?></p>
    <p class="title"><?php echo $p_desc; ?></p>
