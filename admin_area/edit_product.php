			...
			<div class="panel-body">
				<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
    					...
    					<input type="number" name="product_stock" class="form-control" required value="<?php echo $p_stock; ?>">
					</div>
					<div class="form-group">
...
if (isset($_POST['update'])) {
    ...
    // Ambil nama file gambar baru jika diunggah
    ...
    // Jika file gambar tidak diunggah, gunakan gambar lama
