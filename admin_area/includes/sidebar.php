...
<nav class="navbar navbar-inverse navbar-fixed-top" style="width:1569px" >
    ...
    <a href="index.php?dashboard"<?php echo $admin_id ?>"><i class="fa fa-fw-user"></i>Profile</a>
    ...
    <a href="index.php?view_product_cat"><i class="fa fa-fw-gear"></i>Product <br>Categories
