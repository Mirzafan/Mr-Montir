...
.c-9 {
  transform: translateX(-90px); /* Pindahkan lebih ke kiri */
  position: relative;
}
  </style>
  ...
  <div class="c-9">
    <div class="rx">
      <div class="box-header">
        <center>
          <h2>Contact to Us</h2>
          <p>Jika Punya Pertanyaan Telepon Kami</p>
          <p> Telpon kami melalui nomor (0291) 682266</p>
        </center>
      </div>
...
$receiverEmail="abiyanhmad@gmail.com";
