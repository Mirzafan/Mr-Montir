...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <style>
.c-9 {
  transform: translateX(-100px); /* Pindahkan lebih ke kiri */
  position: relative;
}
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($run_check_email) > 0) {
        // If email exists, show warning message
        echo "<script>alert('Alamat email yang Anda masukkan sudah terdaftar. Tolong gunakan alamat yang berbeda.')</script>";
    ...
    // Store customer_name and email in session
